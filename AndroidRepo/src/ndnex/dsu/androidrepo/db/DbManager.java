...
public class DbManager implements OnVerifiedInterest, OnVerifyInterestFailed {
	...
	/*
	 * Reading data from Location tables according to location
	 */
	public Cursor readLocationByLocation(int range, float centerLatitude, float centerLongtitude, float radius) {
		SQLiteDatabase db = mDbHelper.getReadableDatabase();
		String[] projection = {
				Location._ID,
				Location.COLUMN_NAME_TIME_STAMP,
